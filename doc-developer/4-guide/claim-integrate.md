...
## 2.3. Query and mutate credentail

Y﻿ou can get credential detail, check if a wallet address in eligible against this credential or verify this credential with a wallet address.

### 2.4.1. Get credentail info
